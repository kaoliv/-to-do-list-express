...
router.get('/:id/edit', async (req, res) => {
  try {
    ...
    res.status(500).render('pages/error', { error: 'Erro ao carregar o formulário a ser editado!' })
  }
})
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    res.status(500).render('pages/error', { error: 'Erro ao excluir a lista de tarefas!' })
  }
})
